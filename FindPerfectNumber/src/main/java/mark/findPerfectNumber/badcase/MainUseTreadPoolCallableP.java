...
public class MainUseTreadPoolCallableP {

    final static Logger logger = Logger.getLogger(MainUseTreadPoolCallableP.class);
    ...
    public static void main(final String[] args) throws InterruptedException {
        ...
        for (int i = 1; i < max; i += interval) {
            futures.add(executor.submit(new WorkerCallableParallelStream(i, i + (interval - 1))));
        }
        try {
